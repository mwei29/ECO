...
ESM_test$distr_yes <- ifelse(ESM_test$ER_yes == 1 & 
                             (!is.na(ESM_test$esm_howinfluence) & ESM_test$esm_howinfluence == 10 | 
                              !is.na(ESM_test$er_othermethods_distraction) & ESM_test$er_othermethods_distraction == 1), 
                             1, 0)
ESM_test$min_yes <- ifelse(ESM_test$ER_yes == 1 & 
                           ...
                           1, 0)
ESM_test$reap_yes <- ifelse(ESM_test$ER_yes == 1 & 
...
describe(data_b[c(variables, "PSS_gmc", "CESD_gmc", "IBES_gmc", "NIHCB_gmc","stress_gmc")])
```
