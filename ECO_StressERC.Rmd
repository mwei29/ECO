...
Higher momentary within-person stress is associated with using more distraction.
Higher between-person stress is associated with using more distraction.
```{r withinER mod,echo=TRUE,eval=TRUE,warning=F, cache=TRUE, message=F}
distr <- glmer(distr_yes ~ stress_w + stress_b + CESD_gmc + IBES_gmc + NIHCB_gmc + Group + 
                        (1 | PID), 
                        family = binomial(link = "logit"),
                        data = data)

summary(distr)
distr <- glmer(distr_yes_prompt ~ stress_w + stress_b + CESD_gmc + IBES_gmc + NIHCB_gmc + Group + 
                        (1 | PID), 
                        family = binomial(link = "logit"),
                        data = data)

summary(distr)
min <- glmer(min_yes ~ stress_w + stress_b + CESD_gmc + IBES_gmc + NIHCB_gmc + Group + 
                        (1 | PID), 
                        family = binomial(link = "logit"),
                        data = data)

summary(min)
min <- glmer(min_yes_prompt ~ stress_w + stress_b + CESD_gmc + IBES_gmc + NIHCB_gmc + Group + 
                        (1 | PID), 
                        family = binomial(link = "logit"),
                        data = data)

summary(min)
reap <- glmer(reap_yes ~ stress_w + stress_b + CESD_gmc + IBES_gmc + NIHCB_gmc + Group + 
                        (1 | PID), 
                        family = binomial(link = "logit"),
                        data = data)
...
distr <- glmer(distr_yes ~ stress_w*CESD_gmc + stress_b*CESD_gmc + IBES_gmc + NIHCB_gmc + Group + 
                        (1 | PID), 
                        family = binomial(link = "logit"),
                        data = data)

summary(distr)
distr <- glmer(distr_yes_prompt ~ stress_w*CESD_gmc + stress_b*CESD_gmc + IBES_gmc + NIHCB_gmc + Group + 
                        (1 | PID), 
                        family = binomial(link = "logit"),
                        data = data)
