...
#CESD
distr <- glmer(distr_yes ~ stress_w*CESD_gmc + stress_b*CESD_gmc + (1 | PID), 
               family = binomial(link = "logit"),
               data = data)
summary(distr)
...
summary(distr)
min <- glmer(min_yes ~ stress_w*CESD_gmc + stress_b*CESD_gmc +(1 | PID), 
                        family = binomial(link = "logit"),
                        data = data)
summary(min)
...
min <- glmer(min_yes ~ stress_w*Group + stress_b*Group + (1 | PID),
                        family = binomial(link = "logit"),
                        data = data,
              control = glmerControl(optimizer = "bobyqa"))
summary(min)
