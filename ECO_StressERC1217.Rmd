...
describe(data_b_exclude%>% select(-PID, -Group))
...
stats<-statsBy(select(data_exclude,c("PID","Group","esm_stressed_lag", "control_lag", "ER_yes","gender_bin","edu_bin","SF36.PCS")),group="PID")
...
g0w<-ggplot(efdata, aes(x=stress_lag_w, y=fit, color=Group,group=Group)) +
    ...
    labs(x= "stress_lag_w", y="ER Initiation", color="Group", fill="Group") +
